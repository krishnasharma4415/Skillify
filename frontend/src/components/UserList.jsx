...
const UserList = () => {
    ...
    return (
        <div className="user-list">
            {users.map((user) => (
                <div key={user.id} className="user-card dark:bg-gray-900 border border-gray-400 text-white rounded-lg shadow-md hover:shadow-lg transition ease-in-out duration-150 flex items-center p-4 gap-4">
